...
| Logo invisible in dark mode | Hugo Blox has **no dark logo variant**. Either keep the header light in both modes (what this site does) or recolour the logo in CSS — see the commented rule in `site/style.css` |
